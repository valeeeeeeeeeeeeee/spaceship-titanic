# Spaceship Titanic — Official Competition Rules (verbatim)

Source: https://www.kaggle.com/c/spaceship-titanic — copied as provided. The operationally
relevant extracts are summarised in `CLAUDE.md`; this file is the full text of record.
